...
<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item {{ Request::is('promocion') | Request::is('promocion/create') ? 'active' : '' }}"><a
                class="d-flex align-items-center" href=""><i data-feather="gift"></i><span
                    class="menu-title text-truncate" data-i18n="Chat">Promociones</span></a>
        </li>
